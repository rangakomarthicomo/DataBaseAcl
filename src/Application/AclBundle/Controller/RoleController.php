...
use Application\AclBundle\Entity\Role;
use Application\AclBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ApplicationAclBundle:Role')->findAll();

        return $this->render('ApplicationAclBundle:Role:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ApplicationAclBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ApplicationAclBundle:Role')->find($id);
        ...
        return $this->render('ApplicationAclBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ApplicationAclBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
